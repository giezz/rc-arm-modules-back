...
-- ddl-end --
ALTER
SCHEMA doc OWNER TO postgres;
-- ddl-end --

SET
search_path TO pg_catalog,public,doc;
-- ddl-end --
...
ALTER TABLE doc.doctor_patient
...
ALTER TABLE doc.patient
    ADD CONSTRAINT patient_status_fk FOREIGN KEY (patient_status_id)
...
ALTER TABLE doc.rehab_program
    ADD CONSTRAINT start_form_fk FOREIGN KEY (start_form_id)
...
ALTER TABLE doc.rehab_program
    ADD CONSTRAINT end_form_fk FOREIGN KEY (end_form_id)
        REFERENCES doc.form (id) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE doc.protocol
    ADD CONSTRAINT rehab_program_fk FOREIGN KEY (rehab_program_id)
...
ALTER TABLE doc.patient
    ADD CONSTRAINT passport_uq UNIQUE (passport_id);
-- ddl-end --
...
ALTER TABLE doc.form_question
    ADD CONSTRAINT form_fk FOREIGN KEY (id_form)
        REFERENCES doc.form (id) MATCH FULL
...
ALTER TABLE doc.form
    ADD CONSTRAINT scale_fk FOREIGN KEY (scale_id)
...
ALTER TABLE doc.exercise
    ADD CONSTRAINT exercise_type_fk FOREIGN KEY (exercise_type_id)
...
ALTER TABLE doc.doctor_specialization
    ADD CONSTRAINT job_specialization_fk FOREIGN KEY (job_specialization_id)
...
ALTER TABLE doc.doctor_position
    ADD CONSTRAINT doctor_fk FOREIGN KEY (doctor_id)
        REFERENCES doc.doctor (id) MATCH FULL
        ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE doc.doctor_position
    ADD CONSTRAINT job_position_fk FOREIGN KEY (job_position_id)
...
ALTER TABLE doc.answer
    ADD CONSTRAINT variant_fk FOREIGN KEY (variant_id)
...
ALTER TABLE doc.module_exercise
    ADD CONSTRAINT exercise_fk FOREIGN KEY (id_exercise)
...
ALTER TABLE doc.program_module
...
ALTER TABLE doc.rehab_program_log
    ADD CONSTRAINT doctor_fk FOREIGN KEY (who_changed)
        REFERENCES doc.doctor (id) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE doc.interpretation
    ADD CONSTRAINT scale_fk FOREIGN KEY (scale_id)
        REFERENCES doc.scale (id) MATCH FULL
        ON DELETE RESTRICT ON UPDATE CASCADE;
-- ddl-end --
...
ALTER TABLE doc.protocol_form_result
    ADD CONSTRAINT protocol_fk FOREIGN KEY (protocol_id)
...
ALTER TABLE doc.protocol_form_result
    ADD CONSTRAINT form_result_fk FOREIGN KEY (form_result_id)
...
ALTER TABLE doc.doctor
    ADD CONSTRAINT _user_fk FOREIGN KEY (_user_id)
...
ALTER TABLE doc.user_role
    ADD CONSTRAINT _role_fk FOREIGN KEY (_role_id)
